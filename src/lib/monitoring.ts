...
type ErrorReport={message:string;stack?:string;digest?:string;route?:string;method?:string;source:"server"|"client"|"job"|"provider";context?:Record<string,string|number|boolean|null>};
